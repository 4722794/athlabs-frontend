          ...
          <div className=" pt-6">
            ...
            <div className=" pt-6">
              ...
              <ol className="list-decimal_ list-inside_ text-white/80 ">
                <li className="mb-2">
                  1.1&quot;Athlabs&quot;refers to the AI-driven digital
                  performance coach application that provides instant,
                  instructive feedback based on exercise performance through
                  handheld videos.
                </li>
                <li className="mb-2">
                  1.2&quot;User&quot;or&quot;You&quot;means any individual who
                  uses the Services provided by Athlabs.
                </li>
                <li className="mb-2">
                ...
                <li className="mb-2">
                  1.4&quot;Content&quot;includes but is not limited to videos,
                  text, images, user feedback, and performance data.
                </li>
                <li className="mb-2">
              ...
              <p className="text-white/80 mb-4">
                ...
                non-exclusive right and license to use the software provided as
              ...
              <p className="text-white/80 mb-4">
                7.1 Your use of the Services is at your sole risk. The Services
                are provided on an&quot;AS IS&quot;and&quot;AS
                AVAILABLE&quot;basis.
              </p>
              <p className="text-white/80 mb-4">
                7.2 Athlabs does not warrant that a) the Services will function
              ...
              <p className="text-white/80 mb-4">
                9.1 Athlabs reserves the right to modify or replace these Terms
              ...
              <p className="text-white/80 mb-4">
                ...
                with the laws of the jurisdiction of Athlabs`&apos;`
                registration, without regard to its conflict of law provisions.
              </p>
