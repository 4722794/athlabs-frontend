...
function ComonToast({ toastObj = {}, setToastObj, className }: any) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <Toast>
        <div
          className={`inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-green-100 text-green-500 dark:bg-green-800 dark:text-green-200 ${className}`}
        >
          {toastObj.type === "s" ? (
