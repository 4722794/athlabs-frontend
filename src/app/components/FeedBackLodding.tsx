...
interface FeedBackLoddingProps {
  fetchFeedback: () => Promise<void>;
  fetchHighlight: () => Promise<void>;
}

function FeedBackLodding({ fetchFeedback,fetchHighlight }: FeedBackLoddingProps) {
  ...
  <button onClick={callBackWhenFail}
    className={`bg-white py-2 px-3 text-sm font-semibold text-black inline-flex h-11 2xl:h-11 min-w-[90px] md:min-w-[110px] 2xl:min-w-[130px] justify-center items-center rounded-lg drop-shadow-md shadow-white/40 hover:bg-gradient-to-r from-[#101828] to-[#44366a] hover:text-white cursor-pointer`}
  >
    Regenerate
  </button>
) : (
  <div className="py-7">
    ...
    <div className="text-white text-center">Please wait</div>
  </div>
)}
