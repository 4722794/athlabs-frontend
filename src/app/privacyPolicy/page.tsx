        ...
        <div className="container mx-auto self-center px-6 md:px-8 flex justify-between items-center">
          <div className=" pt-6">
            ...
            <p className="mb-5 text-white/70">
              This Privacy Policy (&quot;Policy&quot;) sets forth how Athlabs,
              located at 4132, Prestige Shantiniketan, Hoodi, Bangalore 560048,
              India (&quot;Company&quot;), handles the personal data of its
              users in relation to the services provided by the Athlabs app. The
              app offers AI-driven analysis of exercise performance through
            ...
            <p className="mb-5 text-white/70">
              ...
              directly or indirectly identify you. However, it is essential to
              clarify that while using Athlabs, your facial features and other
